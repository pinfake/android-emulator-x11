...
RUN echo "y" | android update sdk --no-ui --force -a --filter extra-android-m2repository,extra-android-support,platform-tools,android-23,build-tools-23.0.1,sys-img-x86-android-23
